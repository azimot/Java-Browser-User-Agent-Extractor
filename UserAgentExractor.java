...
public class UserAgentExractor {
    ...
    public static UserAgent getClientSpec(String clientUserAgent) {
        ...
        // Other browsers
        else if ((nameOffset = clientUserAgent.lastIndexOf(" ") + 1) < (verOffset = clientUserAgent.lastIndexOf(""))) {
            browserName = clientUserAgent.substring(nameOffset, verOffset);
            browserVersion = clientUserAgent.substring(verOffset + 1);
        }
